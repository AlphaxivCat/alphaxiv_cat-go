...
func TestBriefV1SeenGetSeen(t *testing.T) {
	...
	_, err := client.Briefs.V1.Seen.GetSeen(context.TODO())
	if err != nil {
...
func TestBriefV1SeenMarkSeen(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	err := client.Briefs.V1.Seen.MarkSeen(context.TODO(), alphaxivcat.BriefV1SeenMarkSeenParams{
