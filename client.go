...
// interacting with the alphaxiv_cat API. You should not instantiate this client
...
type Client struct {
	...
	GoogleScholar GoogleScholarService
	Arxiv         ArxivService
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("ALPHAXIV_CAT_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("ALPHAXIV_CAT_CUSTOM_HEADERS"); ok {
...
// environment (ALPHAXIV_CAT_API_KEY, ALPHAXIV_CAT_BASE_URL). The option passed in
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Papers = NewPaperService(opts...)
	r.Emails = NewEmailService(opts...)
	r.Users = NewUserService(opts...)
	r.Assistant = NewAssistantService(opts...)
	...
	r.GoogleScholar = NewGoogleScholarService(opts...)
	r.Arxiv = NewArxivService(opts...)
	r.APIKeys = NewAPIKeyService(opts...)
	r.Admin = NewAdminService(opts...)
	r.Wrapped = NewWrappedService(opts...)
	r.Notifications = NewNotificationService(opts...)
	r.Sitemaps = NewSitemapService(opts...)
	r.Retrieve = NewRetrieveService(opts...)
	r.Retool = NewRetoolService(opts...)
	r.Briefs = NewBriefService(opts...)
	r.Research = NewResearchService(opts...)
