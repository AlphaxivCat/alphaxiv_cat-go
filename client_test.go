...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Papers.Versions.RequestAITranslation(
		context.Background(),
	...
	if userAgent != fmt.Sprintf("AlphaxivCat/Go %s", internal.PackageVersion) {
...
func TestContextDeadlineStreaming(t *testing.T) {
	...
	go func() {
		...
		stream := client.Assistant.V2.ChatStreaming(deadlineCtx, alphaxivcat.AssistantV2ChatParams{
			Files: []alphaxivcat.AssistantV2ChatParamsFile{{
				ContentType: "contentType",
				URL:         "https://example.com",
			}},
			LlmChatID:          alphaxivcat.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			Message:            "message",
...
func TestContextDeadlineStreamingWithRequestTimeout(t *testing.T) {
	...
	go func() {
		...
		stream := client.Assistant.V2.ChatStreaming(
			context.Background(),
			alphaxivcat.AssistantV2ChatParams{
				Files: []alphaxivcat.AssistantV2ChatParamsFile{{
					ContentType: "contentType",
					URL:         "https://example.com",
				}},
